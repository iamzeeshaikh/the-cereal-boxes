...
export const homepageFaqs = [
  ...
  {
    question: "What is your minimum order quantity for custom cereal boxes?",
    answer:
      "Minimum order quantity depends on the box size, print coverage, structure, and finishing requirements. We support low MOQ projects for launch-stage brands and larger runs for wholesale buyers.",
  },
  {
    question: "How fast can you produce custom cereal packaging?",
    answer:
      "Turnaround varies by quantity, printing complexity, and finishing, but most projects are planned around a fast quote-to-production workflow so buyers can move quickly once specs are approved.",
  },
  {
    question: "Do you provide free design support?",
    answer:
      "Yes. We help with dielines, panel planning, print recommendations, barcode placement, and finish direction so your cereal packaging feels retail-ready before production.",
  },
  {
    question: "Can you match my existing cereal brand colors?",
    answer:
      "Yes. We can work with CMYK and Pantone-based print direction depending on the project so your packaging remains consistent across product lines and retail formats.",
  },
  {
    question: "Can I order both custom cereal boxes and cereal mylar bags together?",
    answer:
      "Yes. We can support bag-and-box packaging systems so the outer carton and inner freshness packaging are planned together around the same dimensions and product requirements.",
  },
  {
    question: "Do you ship custom cereal boxes nationwide in the USA?",
    answer:
      "Yes. The Cereal Boxes supports cereal packaging projects for buyers across the United States, including launch runs, retail programs, and wholesale packaging supply.",
  },
  {
    question: "Can you help if I only have an idea and not final artwork?",
    answer:
      "Yes. Many clients start with basic packaging goals instead of final files. We can help shape dimensions, print direction, finishes, and artwork requirements before production begins.",
  },
  {
    question: "Are mini cereal boxes available for samples and promotions?",
    answer:
      "Yes. Mini cereal boxes are a strong fit for hospitality packs, trial-size programs, event campaigns, variety bundles, and promotional cereal launches.",
  },
  {
    question: "What finishing options are available for printed cereal boxes?",
    answer:
      "Popular finishing options include matte, gloss, aqueous coating, soft-touch, foil stamping, embossing, debossing, window patching, and insert-based presentation upgrades.",
  },
  {
    question: "Can you support wholesale cereal packaging for repeat orders?",
    answer:
      "Yes. We work with buyers who need larger runs, recurring production schedules, and packaging systems built for scaling cereal brands and retail supply.",
  },
  {
    question: "How do I get a quote for custom cereal packaging?",
    answer:
      "Use the quote form to share your dimensions, quantity, material preferences, print needs, and any artwork files. Our team reviews the details and responds with a custom quote path.",
  },
  {
    question: "Do you offer blank or plain cereal boxes for private label use?",
    answer:
      "Yes. We manufacture blank and plain cereal cartons for labeling, over-stickering, warehouse packing, white-label workflows, and early-stage product testing.",
  },
];
