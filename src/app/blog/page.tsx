        ...
        <Container>
          <div className="surface-card p-7 sm:p-9">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                ["Dimensions", "Guides that help buyers choose the right cereal box size and layout."],
                ["Materials", "Articles covering board choices, print direction, and packaging systems."],
                ["Use cases", "Resources for retail launches, mini packs, and promotional packaging."],
              ].map(([title, copy]) => (
